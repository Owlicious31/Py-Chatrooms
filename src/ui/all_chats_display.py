...
class SessionManagementFrame(ctk.CTkFrame):
    ...
    def __init__(self,master: ctk.CTk) -> None:
        super().__init__(master=master,fg_color=DARKER_GREY,height=300,width=400)

        self.add_session_label = ctk.CTkLabel(master=self,text="Add session",font=("arial",18,"normal"))
        self.add_session_label.grid(column=0,row=0,columnspan=2,pady=10)

        # TODO - complete GUI by adding entrys for adding sessions and creating them

        # TODO - add comments and docstrings to all modules
        # TODO - Add logging and log files


class AllChatsDisplay(ctk.CTk):
    ...
    def __init__(self) -> None:
        ...
        self.session_management_display.grid(column=0,row=2)


if __name__ == "__main__":
    display = AllChatsDisplay()
    display.mainloop()
